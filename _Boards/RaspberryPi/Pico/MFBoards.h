...
#define FIRST_ANALOG_PIN    26   // first pin of anlog in, needed to calculate the position of calibration data in EEPROM
#endif
#ifndef MAX_ANALOG_PIN
#define MAX_ANALOG_PIN      3    // max. numbers of analog pins, could be different from MAX_ANALOG_INPUTS, needed for calibration data in EEPROM
#endif
