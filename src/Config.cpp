...
#include "Output.h"
#if defined(ARDUINO_ARCH_RP2040) || defined(ARDUINO_ARCH_ESP32) || defined(ARDUINO_ARCH_MEGAAVR) || defined(CORE_TEENSY)
...
#elif defined(ARDUINO_ARCH_RP2040) || defined(ARDUINO_ARCH_ESP32) || defined(ARDUINO_ARCH_MEGAAVR) || defined(CORE_TEENSY)
